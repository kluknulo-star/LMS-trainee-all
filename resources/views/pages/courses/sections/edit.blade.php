        ...
        <div class="edit__container edit__container-course classic-box mrauto">
            ...
            <form method="post" action="{{ route('courses.update.section', ['id' => $courseId, 'section_id' => $section->item_id]) }}" class="edit__form form">
                ...
                <select class="select mb20" name="sectionType" id="">
                    <option name="Article" value="1" @if ($section->type_id == 1) selected @endif class="edit__input col-input input">Article</option>
                    <option name="YoutubeVideoLink" value="2"  @if ($section->type_id == 2) selected @endif class="edit__input col-input input">YouTube Video Link</option>
                    <option name="Test" value="3"  @if ($section->type_id == 3) selected @endif class="edit__input col-input input">Test</option>
                </select>
